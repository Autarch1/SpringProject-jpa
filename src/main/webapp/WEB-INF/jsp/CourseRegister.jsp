    ...
    <div class="row justify-content-center" > <!-- Center the content horizontally -->
        <div class="col-md-6">
            <div class="card p-4">
                ...
                <form:form action="/SpringProject/ProcessCourseRegister" modelAttribute="courseBean" method="POST">

                    <div class="mb-3">
                        <form:label for="name" class="form-label" path="courseId">Id</form:label>
                        <form:input type="text" class="form-control" id="id" path="courseId"  value="COU${String.format('%03d', nextCourseId)}" readonly="true"/>
                    </div>
                    <div class="mb-3">
                        <form:label for="name" class="form-label" path="courseName">Course Name</form:label>
