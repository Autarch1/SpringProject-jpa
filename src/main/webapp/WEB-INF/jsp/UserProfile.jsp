...
<div class="container mt-5">
    <div class="card p-4">
        ...
        <form:form action="/SpringProject/UserProfileUpdate" modelAttribute="updatebean">

            <div class="mb-3">
                <form:label for="name" class="form-label" path="userId">Id</form:label>
                <form:input type="text" class="form-control" id="id" path="userId"  value="${currentUser.userId }" readonly="true"/>
            </div>
            <div class="mb-3">
                <form:label for="name" class="form-label" path="userName">Name</form:label>
                <form:input type="text" class="form-control" id="name" path="userName"  value="${currentUser.userName }"/>
            </div>
            <div class="mb-3">
                <form:label for="email" class="form-label" path="userEmail" >Email</form:label>
                <form:input type="email" class="form-control" id="email"  path="userEmail" value="${currentUser.userEmail }" readonly="true"/>
            </div>
            <div class="mb-3">
                <form:label for="password" class="form-label" path="userPassword">Password</form:label>
                <form:input type="password" class="form-control" id="password" path="userPassword" value="${currentUser.userPassword }" />
            </div>
            <div class="mb-3">
                <label for="confirmPassword" class="form-label">Confirm Password</label>
                <input type="password" class="form-control" id="confirmPassword" name="cPassword"  value="${currentUser.userPassword }"/>
            </div>
            <div class="mb-3">
                <label for="userRole" class="form-label">User Role</label>
                <form:select class="form-select" id="userRole" path="userRole" value="${currentUser.userRole }">
                    <c:if test="${isAdmin }">
